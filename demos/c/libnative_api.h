...
typedef struct {
  libnative_KNativePtr pinned;
} libnative_kref_opplibdemo_Clazz;
    ...
    struct {
      struct {
        struct {
          ...
          libnative_kref_opplibdemo_Clazz (*Clazz)();
          const char* (*craigMethodGreeting)(libnative_kref_opplibdemo_Clazz thiz);
          libnative_KULong (*memberFunction)(libnative_kref_opplibdemo_Clazz thiz, libnative_KInt p);
        } Clazz;
